...
author: "Carla Morgado, Noelia Teruel y Helena Albors"
...
### 3.1.1.**PROPORCIÓN DE MUJERES EMPRESARIAS**{.tabset .tabset-pills}
...
En tercer lugar, en China se requiere una media de 8 días para iniciar un negocio.
...
porcSALARIOgg <- ggplotly(porcSALARIOgg)
```


<br>

### 3.2.2. **DIFERENCIA DE SALARIOS**{.tabset .tabset-pills}
