---
title: "El papel de las mujeres en la escuela y el trabajo"  #- título
...
format: 
  revealjs:
    ...
    title-slide-attributes: #- atributos para la slide de titulo
      data-background-color: "#FFF0F5"   #- color de R-ladies
...
Por último, hemos incluido en este apartado la proporción de tiempo dedicado al trabajo doméstico y de cuidados no remunerado (h/dia) de hombres y mujeres.  
